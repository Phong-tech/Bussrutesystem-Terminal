...
* strukturering av større C++-programmer
* oppdeling av kode i klasser og funksjoner
* bruk av objekter og objektorienterte prinsipper
* håndtering av data i et terminalbasert program
